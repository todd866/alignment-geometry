...
For small $\kappa$ (near uniform), $r \to 0$ and $I(\kappa) \to 1$: samples are maximally informative about $\kappa$. For large $\kappa$ (high concentration), $r \to 1$ and $I(\kappa) \to 0$: the distribution is nearly deterministic, so samples provide little information about small changes in $\kappa$.
